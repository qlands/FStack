"""
Provides plugin services to the {{ cookiecutter.project_name }}
...
TEST_PLUGINS_ENTRY_POINT_GROUP = "{{ cookiecutter.project_name }}.test_plugins"
...
def load_all(settings):
    """
    Load all plugins listed in the '{{ cookiecutter.project_name }}.plugins' settings variable.
