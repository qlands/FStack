# -*- coding: utf-8 -*-
"""
    {{ cookiecutter.project_name }}.resources.resources
    ~~~~~~~~~~~~~~~~~~

    Provides the basic view classes for {{ cookiecutter.project_name }} and
...
class PublicView(object):
    ...
    def append_to_errors(self, error):
        self.request.response.headers["{{ cookiecutter.project_name }}_error"] = "true"
